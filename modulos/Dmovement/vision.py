...
def check_motion_v1(prev_frame, current_frame):
    ...
    # Return motion detection flag, the frame with highlights, the diff map, and rectangles
    return len(contours_rects) > 0, current_frame_copy, abs_diff, contours_rects
